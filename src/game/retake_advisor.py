...
_RETAKE_TIMES: Dict[str, Dict[Tuple[str, str], float]] = {
    "ascent": {
        ("CT Spawn", "A Site"): 5.0,
        ("CT Spawn", "B Site"): 7.0,
        ("Mid Market", "A Site"): 6.0,
        ("Mid Market", "B Site"): 6.0,
        ("B Link", "B Site"): 3.0,
        ("A Link", "A Site"): 3.0,
    },
    "bind": {
        ...
        ("A Short", "A Site"): 3.0,
        ("B Long", "B Site"): 4.0,
        ("Teleporter", "A Site"): 5.0,
        ("Teleporter", "B Site"): 5.0,
    },
    "haven": {
        ("CT Spawn", "A Site"): 7.0,
        ("CT Spawn", "B Site"): 5.0,
        ("CT Spawn", "C Site"): 7.0,
        ("Mid Courtyard", "B Site"): 4.0,
        ("Mid Courtyard", "A Site"): 6.0,
        ("Mid Courtyard", "C Site"): 6.0,
    },
    "split": {
        ("CT Spawn", "A Site"): 6.0,
        ("CT Spawn", "B Site"): 6.0,
    ...
    "icebox": {
        ("CT Spawn", "A Site"): 8.0,
        ("CT Spawn", "B Site"): 6.0,
        ("Mid Boiler", "B Site"): 5.0,
        ("Mid Boiler", "A Site"): 6.0,
    },
}
